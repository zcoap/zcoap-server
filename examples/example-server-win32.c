...
//Statically define nodes
//Although there is a mechanism to dynamically add nodes at runtime, zcoap-server is 
//designed around the static definition use case.
